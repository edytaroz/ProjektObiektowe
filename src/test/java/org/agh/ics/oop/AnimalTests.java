...
public class AnimalTests {
    ...
    @Test
    void foodConflict(){
        Animal animal1 = new Animal(150,50,8,10,20,new Vector2d(2,2));
        Animal animal2 = new Animal(113,50,8,10,20,new Vector2d(2,2));
        Animal animal3 = new Animal(113,50,8,10,20,new Vector2d(2,2));
    ...
    @Test
    void deathTest(){
        Animal animal = new Animal(90,20,6,20,20,new Vector2d(2,2));
        animal.move();
        animal.move();
        animal.move();
        animal.move();
